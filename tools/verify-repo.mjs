...
requireCount("Release files", "releases", (file) => file.endsWith(".md"), 8);
...
requireText("package.json", "\"version\": \"1.7.0\"");
...
requireText("PROJECT-STATUS.md", "v1.7.0");
requireText("FINAL-REVIEW.md", "Ready for v1.7.0 release");
