...
requireCount("Release files", "releases", (file) => file.endsWith(".md"), 5);
...
requireText("package.json", "\"version\": \"1.4.0\"");
...
requireText("PROJECT-STATUS.md", "v1.4.0");
requireText("FINAL-REVIEW.md", "Ready for v1.4.0 release");
