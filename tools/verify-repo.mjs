...
requireCount("Release files", "releases", (file) => file.endsWith(".md"), 14);
...
requireText("package.json", "\"version\": \"2.3.0\"");
...
requireText("PROJECT-STATUS.md", "v2.3.0");
requireText("FINAL-REVIEW.md", "Ready for v2.3.0 release");
...
requireText("docs-site/README.md", "stack-composer.html");
...
requireText("docs-site/site-map.json", "\"kind\": \"composer\"");
...
requireText("docs-site/build-docs-site.mjs", "renderStackComposerPage");
requireText("docs-site/build-docs-site.mjs", "composerAgentOptions");
...
requireText("docs-site/assets/site.js", "initStackComposer");
requireText("docs-site/assets/site.js", "composer-agent");
requireText("docs-site/assets/site.js", "initMaturityScorecard");
requireText("catalog/github-repositories.md", "CopilotKit/CopilotKit");
requireText("modules/05-frontend-client/README.md", "CopilotKit/CopilotKit");
requireText("releases/v1.8.0.md", "CopilotKit");
requireText("packages/README.md", "Code Foundation Packages");
...
requireText("packages/database/src/index.mjs", "createSqliteDatabase");
...
requireText("apps/web-admin-app/src/server.mjs", ".sqlite");
...
requireText("releases/v2.3.0.md", "SQLite Database Adapter");
...
requireFiles([
  ...
  "packages/security/test/security.test.mjs",
  ...
  "packages/data/test/data.test.mjs",
