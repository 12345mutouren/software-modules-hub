...
- [v1.4.0 发布说明](releases/v1.4.0.md)
- [发布记录](CHANGELOG.md)
...
6. 使用 [项目启动器](https://12345mutouren.github.io/software-modules-hub/project-starter.html)、[决策指南](decision-guides/README.md)、[项目启动包](project-kickoff/README.md) 和 [项目生成器](starter-generator/README.md)，把一个软件想法整理成可执行项目计划。
