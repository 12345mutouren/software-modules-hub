...
| Entry | Purpose |
| --- | --- |
| `packages/README.md` | 可复用底层代码包：core、security、auth、database、data、api |
| `packages/database/README.md` | 迁移、适配器、事务、JSON 文件和 SQLite SQL 数据库底层 |
...
| `apps/web-admin-app/README.md` | 可启动的浏览器管理后台 |
