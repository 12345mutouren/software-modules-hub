...
| 3 | [reference/master-index.md](../reference/master-index.md) | 找到按用途组织的入口 |
| 4 | [catalog/github-repositories.md](../catalog/github-repositories.md) | 看每类模块有哪些代表仓库 |
| 5 | [checklists/phase-10-completeness.md](../checklists/phase-10-completeness.md) | 确认当前阶段覆盖情况 |

## 30-Minute Tour

1. 阅读 [modules/README.md](../modules/README.md)，理解 10 个模块。
2. 任选 2 个模块深读，例如账号系统和数据库层。
3. 打开 [examples/full-stack-mini-app](../examples/full-stack-mini-app/README.md)，对照代码看用户、会话、权限、CSRF、订单和文档。
4. 查看 [templates/complete-apps](../templates/complete-apps/README.md)，选一个最接近自己想做的软件类型。
5. 阅读 [architecture/README.md](../architecture/README.md)，把模板和运行时结构连起来。
6. 阅读 [decision-guides/README.md](../decision-guides/README.md)，用决策树做技术选择。
7. 打开 [project-kickoff/README.md](../project-kickoff/README.md)，开始填项目启动模板。
